    ...
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <!-- navbar-brand is hidden on larger screens, but visible when the menu is collapsed--><a
                href="${pageContext.request.contextPath}/" class="navbar-brand">Prank WebApp</a>
        </div>
        <!-- Collect the nav links, forms, and other content for toggling-->
        <div id="bs-example-navbar-collapse-1" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li><a href="${pageContext.request.contextPath}/"><span aria-hidden="true"
                                                      class="glyphicon glyphicon-home"></span>Prank
                </a>
                </li>
